# -*- coding: utf-8 -*-
"""Giovanna_Atividade_QA_Banco_do_Stark.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_Qofuln2XexelHtsBLAkd6Qj8iArr29X
...
**Pré-condição:** Rodar o banco do Stark

**Passos:** Criar conta
1.  Rodar o banco
2.  banco.criar_conta('tony')
3.  
**Resultado esperado:**  OK - Conta criada para: Tony


**Resultado obtido:**  OK - Conta criada para : Tony
**Status (Pass/Fail):** Passou
...
**Pré-condição:** Ter saldo suficiente na conta

**Passos:**  
1. Rodar o banco

2. banco.sacar('tony', 2000)
3.  
**Resultado esperado:** Saque inválido - o seu saldo é de xx

**Resultado obtido:**  OK - Saque realizado para: Tony
...
**ID:** CT-003  
**Título/Objetivo:** Consulta de saldo

**Pré-condição:** Ver o saldo

**Passos:**  
1.  Rodar o banco
2.  banco.saldo_atual('tony')
3.  
**Resultado esperado:** Conta não encontrada
**Resultado obtido:**  Conta não encontrada
**Status (Pass/Fail):** Passou
**Evidência:** banco.saldo('1234')
...
**Descrição:**  Consigo depositar 0 reais

**Passos para reproduzir:**  
1. Rodar o banco
2. banco.depositar('Stark', 2000)
3. Depósito realizado: 2000

**Resultado esperado:** Deposito realizado com o valor 0

**Resultado obtido:** O valor depositado foi 0

**Evidência:** === DEPÓSITOS ===
OK - Depósito realizado: 1000

**Impacto/Risco:**  Lentidão no sistema
