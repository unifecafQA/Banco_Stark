...
**Resultado esperado:** O sistema deve rejeitar o depósito, pois o valor precisa ser maior que 0.  
**Resultado obtido:** O sistema aceitou o depósito e exibiu a mensagem:
...
**Resultado esperado:** O sistema deve rejeitar depósitos com valor negativo.
**Resultado obtido:**  O sistema aceitou o depósito negativo e exibiu:
...
**Pré-condição:**  Conta "tony" existente e conta "thor" inexistente.
**Passos:**  
1.  banco.transferir('tony', 'thor', 50)

**Resultado esperado:**  O sistema deve bloquear a transferência e informar que a conta destino não existe.
**Resultado obtido:**  O sistema exibiu mensagem de erro informando que a conta destino não foi encontrada.
...
**Descrição:**  O sistema permite realizar depósito com valor 0, o que viola a regra de negócio que exige que o valor do depósito seja maior que 0.

**Passos para reproduzir:**  
1.  banco.criar_conta('tony')
2.  banco.depositar('tony', 0)

**Resultado esperado:**  O sistema deveria rejeitar o depósito e exibir mensagem de erro.
**Resultado obtido:**  O sistema aceita o depósito e exibe:

OK - Depósito realizado: 0
**Evidência:**  Teste N1 - Depósito com valor zero
OK - Depósito realizado: 0
**Impacto/Risco:**  Permite registros financeiros inválidos e pode causar inconsistências no controle de transações.
...
**Descrição:**  O sistema aceita depósitos com valor negativo, o que reduz o saldo da conta, violando as regras de negócio.

**Passos para reproduzir:**  
1.  banco.criar_conta('tony')
2.  banco.depositar('tony', -100)
3.  

**Resultado esperado:**  O sistema deveria rejeitar o depósito negativo.
**Resultado obtido:**  O sistema aceita o depósito negativo e reduz o saldo.
**Evidência:**  Teste N2 - Depósito negativo
OK - Depósito realizado: -100
SALDO tony = 600.0
**Impacto/Risco:**  Pode gerar inconsistências financeiras e permitir manipulação indevida de saldo.

## Template — Bug Report
**Título:**  Falta validação para valor de depósito maior que zero
**Severidade (Baixa/Média/Alta):**  Média
**Prioridade (Baixa/Média/Alta):**  Média
**Ambiente:** Google Colab / Python 3.x / Banco do Stark  

**Descrição:**  O método de depósito não valida se o valor informado é maior que zero, permitindo valores inválidos.

**Passos para reproduzir:**  
1.  Criar conta "tony".
2.  Executar depósito com valor 0 ou negativo.
3.  

**Resultado esperado:**  Sistema deveria validar e impedir valores menores ou iguais a zero.
**Resultado obtido:**  Sistema aceita os valores e realiza a operação.
**Evidência:**  OK - Depósito realizado: 0
OK - Depósito realizado: -100
**Impacto/Risco:**  Pode causar inconsistência de dados e problemas no controle financeiro do sistema.
