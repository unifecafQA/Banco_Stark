# -*- coding: utf-8 -*-
"""Gustavo jonas Atividade_QA_Banco_do_Stark.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1feXTsijSbLAbC2Irs6DtZKSQvKvKR3q6
...
**Evidência:**  
Teste N2 - Depósito negativo OK - Depósito realizado: -100
...
**Descrição:**  
O sistema aceita depósitos de valor zero, o que não está de acordo com a regra de negócio que exige que os depósitos sejam maiores que zero.
...
## Template — Bug Report
**Título:**  Sistema aceita depósito com valor negativo Severidade (Baixa/Média/Alta): Alta
**Severidade (Baixa/Média/Alta):**  Alta
**Prioridade (Baixa/Média/Alta):**  Alta
**Ambiente:** Google Colab / Python 3.x / Banco do Stark  

**Descrição:**  
O sistema permite depósitos com valor negativo, o que reduz o saldo da conta e viola as regras do sistema bancário.
**Passos para reproduzir:**  
1.  Criar conta "tony".
2.  Executar depósito com valor -100.
3.  Consultar saldo da conta.

**Resultado esperado:**  O sistema deve bloquear depósitos negativos e exibir erro Resultado obtido: O sistema aceita o depósito negativo e reduz o saldo da conta Evidência: Teste N2 - Depósito negativo OK - Depósito realizado: -100
**Resultado obtido:**  
**Evidência:**  
